...
/***/ function(module, exports, __webpack_require__) {
	...
	(function (undefined) {
		...
		let React = __webpack_require__(5);

		let ReactDOM = __webpack_require__(162);
			...
			render: function () {
				return React.createElement(
					...
					React.createElement(
						...
						React.createElement(ChatList, { chat: this.state.chat }),
		...
		let ChatList = React.createClass({
			...
			render: function () {
				...
				return React.createElement(
					'div',
					{ className: 'chatList', ref: 'chatList' },
					chatNodes
				);
			}
		});
		...
		let OnlineNumber = React.createClass({
			displayName: 'OnlineNumber',

			render: function () {
				return React.createElement(
					'div',
					{ className: 'onlineNumber' },
					React.createElement(
						'p',
						null,
						this.props.number
			...
			render: function () {
				return React.createElement(
					...
					React.createElement(
						'div',
						{ className: 'edit' },
						React.createElement('textarea', { value: this.state.text, onChange: this.handleInput, onKeyDown: this.handleKeyDown, disabled: !this.props.condition })
					)
				);
			}
		});
			...
			render: function () {
				return React.createElement(
					...
					React.createElement(
						...
						React.createElement(
							'span',
							{ className: this.props.author.toLowerCase() },
							this.props.author
						),
						': ',
						this.props.message
		...
		let VideoBox = React.createClass({
			...
			render: function () {
				return React.createElement(
					'div',
					{ className: 'videoBox' },
					React.createElement(Video, { owner: 'stranger' }),
					React.createElement(Video, { owner: 'you' })
				);
			}
		});
		...
		let Video = React.createClass({
			...
			render: function () {
				return React.createElement(
					'div',
					{ className: 'video' },
					React.createElement('video', { autoPlay: true, ref: this.props.owner })
				);
			}
		});
		...
		let StartButton = React.createClass({
			...
			render: function () {
				return React.createElement(
					'button',
					{ className: 'newButton btn', onClick: this.handleClick },
					this.props.text
				);
			}
		});
		...
		ReactDOM.render(React.createElement(ChatRoom, null), document.querySelector('#container'));
	})();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var require;var require;/* WEBPACK VAR INJECTION */(function(global) {(function (f) {
	  if (true) {
	    module.exports = f();
